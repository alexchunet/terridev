...
ind2 <- list(wdi_SP.POP.TOTL,biodiv,wind,solar,defor2,coastline_table,trust_in_politicians,social_capital,
             ...
             wdi_EN.ATM.PM25.MC.M3,wdi_AG.LND.ARBL.HA.PC,wdi_AG.LND.ARBL.HA,wdi_AG.LND.ARBL.ZS,wdi_AG.YLD.CREL.KG,wdi_VC.IDP.NWDS,wdi_EG.ELC.ACCS.ZS,
...
#integrated <- integrated %>% rename("Population"=SP.POP.TOTL,
#"Biodiversity"=biodiv,
#"Wind resources"=wind,
#"Solar resources"=solar,
#"Forest loss"=forest_loss,
#"Coastline"=coastline,
#"Trust in politicians"=trust_poli,
#"Social capital"=social_capital,
#"Surface area"=AG.SRF.TOTL.K2,
#"Urban population"=SP.URB.TOTL,
#"Urban pop. (%)"=SP.URB.TOTL.IN.ZS,
#"Urban growth"=SP.URB.GROW,
#"Net adjusted savings"=NY.ADJ.SVNG.GN.ZS,
#"Air pollution (PM2.5)"=EN.ATM.PM25.MC.M3,
#"Arable land per capita"=AG.LND.ARBL.HA.PC,
#"Cereal yield"=AG.YLD.CREL.KG,
#"Displacement due to disasters"=VC.IDP.NWDS,
#"Access to electricity"=EG.ELC.ACCS.ZS,
#"External debt stock (%GNI)"=DT.DOD.DECT.GN.ZS,
#"Exports (%GDP)"=NE.EXP.GNFS.ZS,
#"Employment in agriculture"=SL.AGR.EMPL.ZS,
#"Forest cover (km2)"=AG.LND.FRST.K2,
#"Forest cover (%)"=AG.LND.FRST.ZS,
#"Forest rents (%GDP)"=NY.GDP.FRST.RT.ZS,
#"Agri. for. fish. (%GDP)"=NV.AGR.TOTL.ZS,
#"Natural capital per capita"=NW.NCA.PC,
#"Air pollution (mort.)"=SH.STA.AIRP.P5,
#"WASH pollution (mort.)"=SH.STA.WASH.P5,
#"Access to sanitation"=SH.STA.BASS.ZS,
#"Homicides rate"=VC.IHR.PSRC.P5,
#"Water availability"=ER.H2O.INTR.PC,
#"Water stress"=ER.H2O.FWST.ZS,
#"Access to water"=SH.H2O.BASW.ZS,
#"Arable land (%)"=AG.LND.ARBL.ZS,
#"Arable land (ha.)"=AG.LND.ARBL.HA,
#"Forst cover per capita"=forest_cover_pc)
